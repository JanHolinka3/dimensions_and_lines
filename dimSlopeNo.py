...
def osadKotuSlopeNo(self, listKotaText, listVeci) -> bpy.types.Object:
    ...
    #body prodlouzeni
    pocetVert += 1
    kotaBaseVert1prodl = functions.pripoctiX(kotaBaseVert1, self.tloustka/2)  
    objectMesh.vertices[pocetVert].co = kotaBaseVert1prodl
    pocetVert += 1
    kotaBaseVert2prodl = functions.pripoctiX(kotaBaseVert2, -self.tloustka/2)  
    ...
    objectMesh.vertices[pocetVert].co = bodSirky1
    pocetVert += 1
    bodSirky1 = functions.pripoctiX(objectMesh.vertices[pocetVert - 1].co, -self.tloustka)  
    objectMesh.vertices[pocetVert].co = bodSirky1
    pocetVert += 1
    ...
    pocetVert +=1
    bodSirky1=functions.pripoctiX(objectMesh.vertices[8].co,(self.tloustka/2)/math.sin(45/(180/math.pi)))
    objectMesh.vertices[pocetVert].co = bodSirky1
    pocetVert +=1   
